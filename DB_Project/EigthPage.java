 ...
 */
@WebServlet(name="EigthPage")
public class EigthPage extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException,IOException {
        PrintWriter out=response.getWriter();
        HttpSession session=request.getSession(false);
        out.println("<p align=\"center\">Welcome "+session.getAttribute("aname")+"</p>");
        out.println("<br>");
        out.println("<form action=\"ServletRemoveSpare\" method=\"post\">");
        out.println("<table align=\"center\" border=1>");
        out.println("<th><b>Remove Spare-Parts ....!!!</b></th>");
        out.println("<tr><td>ENTER SPARE-PART ID : <input type=\"text\" name=\"sid\"/></td></tr>");
        out.println("<tr><td align=\"right\"><input type=\"submit\" value=\"REMOVE\"/></td></tr>");
        out.println("</table>");
        out.println("</form>");
